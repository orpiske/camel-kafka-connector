...
public class CamelMongoDBEndpoint extends MongoDbEndpoint {

    public CamelMongoDBEndpoint(String uri, MongoDbComponent component) {
        super(uri, component);
    }
    ...
    public void initializeConnection() throws CamelMongoDbException {
        try {
            ...
            throw new RuntimeException("Unable to initialize connection");
        }
