...
| *camel.source.endpoint.delay* | Delay before first event is triggered. | 1sL | MEDIUM
...
| *camel.source.endpoint.period* | If greater than 0, generate periodic events every period. | 1sL | MEDIUM
